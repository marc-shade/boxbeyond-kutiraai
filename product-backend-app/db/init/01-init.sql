...
CREATE TABLE dataset_output_table (
	id serial4 NOT NULL,
...
CREATE TABLE dataset_template_table (
	id serial4 NOT NULL,
...
CREATE TABLE finetune_master_table (
    id serial4 NOT NULL,
    model_name varchar NOT NULL,
...
CREATE INDEX idx_finetune_tasks_config_id ON finetune_tasks(config_id);
CREATE INDEX idx_finetune_tasks_status ON finetune_tasks(status);
CREATE INDEX idx_finetune_tasks_created_at ON finetune_tasks(created_at);

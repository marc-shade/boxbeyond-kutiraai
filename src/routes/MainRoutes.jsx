...
const MCPDashboard = Loadable(lazy(() => import('components/RealMCPDashboard')));
const PersonaLabDashboard = Loadable(lazy(() => import('pages/persona-lab/PersonaLabDashboard')));
// ==============================|| MAIN ROUTING ||============================== //

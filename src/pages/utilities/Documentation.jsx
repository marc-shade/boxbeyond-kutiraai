                    ...
                    <Box sx={{ p: 3 }}>
                        ...
                        <Box
                            sx={{
                                p: 2,
                                textAlign: 'center',
                                border: glassmorphismEnabled ? '1px dashed rgba(255, 255, 255, 0.2)' : '1px dashed rgba(0, 0, 0, 0.2)',
                                borderRadius: 2,
                                mb: 2,
                        ...
                        >
                            ...
                            <Box
                                sx={{
                                    width: '100%',
                                    height: 300,
                                    bgcolor: glassmorphismEnabled ? 'rgba(255, 255, 255, 0.05)' : 'rgba(0, 0, 0, 0.03)',
                                    display: 'flex',
                                    alignItems: 'center',

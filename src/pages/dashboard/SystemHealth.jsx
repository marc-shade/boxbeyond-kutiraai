...
const SystemHealth = () => {
  ...
  useEffect(() => {
    const fetchHealthStatus = async () => {
      ...
      const fineTuneServices = await checkConsolidatedServiceHealth('http://localhost:9202/health');
      const agenticServices = await checkConsolidatedServiceHealth('http://localhost:9201/health');
